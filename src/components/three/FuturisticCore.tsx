...
export default function FuturisticCore() {
  ...
  return <group ref={group} position={[0,0,-1.15]}>
    <mesh ref={inner} scale={1.05}>
      ...
      <meshStandardMaterial color="#7b6642" emissive="#c9a96e" emissiveIntensity={.38} roughness={.2} metalness={.8} transparent opacity={.3} wireframe />
    </mesh>
    ...
    <Sparkles count={32} scale={[5,4,3]} size={1.1} speed={.18} opacity={.34} color="#c9a96e" />
