...
const moments=[
  {title:'Ma passion',text:"Tout a commencé par les gestes de la rue : saisir un corps en mouvement, une ombre, une coïncidence. La photographie est devenue une manière d'être attentif.",image:'/images/editorial/about-inspired.webp'},
  {title:'Ma vision',text:"Une image forte n'explique pas tout. Elle laisse de l'espace, une tension, une trace. Je cherche cet instant où le réel semble soudain composé.",image:'/images/editorial/portrait.webp'},
  {title:'Mon style',text:"Contraste, géométrie, couleurs franches et noir profond. Mon langage s'adapte à chaque histoire mais conserve une présence graphique et sincère.",image:'/images/editorial/fashion.webp'},
  {title:'Mon engagement',text:"Être présent sans prendre toute la place. Préparer avec précision, photographier avec instinct, livrer des images exigeantes faites pour durer.",image:'/images/editorial/event.webp'},
];
