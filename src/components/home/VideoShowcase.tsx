...
export default function VideoShowcase() {
  ...
  return <>
    <section ref={root} className="noise relative h-[100svh] min-h-[650px] overflow-hidden bg-black">
      <motion.div className="absolute inset-0" style={{scale}}>{visible && <video ref={video} className="h-full w-full object-cover opacity-75" autoPlay muted loop playsInline preload="metadata" poster="/images/editorial/event.webp"><source src="/video/showcase.mp4" type="video/mp4"/></video>}</motion.div>
