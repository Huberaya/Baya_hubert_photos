...
export default function FinalCTA() {
  return <section className="noise relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-5 py-28 text-center"><Image src="/images/hubert/hubert-17.webp" alt="Coucher de soleil photographié par Hubert Baya" fill sizes="100vw" className="object-cover opacity-25 blur-[2px]"/><div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/35 to-black/80"/>
