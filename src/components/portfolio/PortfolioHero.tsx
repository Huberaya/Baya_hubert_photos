...
export default function PortfolioHero() {
  ...
  return <section ref={root} className="relative flex h-[75vh] min-h-[600px] items-center overflow-hidden bg-[#060606] pt-20">
    <div className="absolute inset-0 opacity-40"><motion.div style={{y:y1}} className="absolute left-[4%] top-[20%] h-[48%] w-[25%] rotate-[-3deg]"><Image src="/images/editorial/portrait.webp" alt="" fill sizes="30vw" className="object-cover grayscale"/></motion.div><motion.div style={{y:y2}} className="absolute right-[6%] top-[8%] h-[60%] w-[27%] rotate-[4deg]"><Image src="/images/editorial/mode-gown.webp" alt="" fill sizes="30vw" className="object-cover"/></motion.div><motion.div style={{y:y1}} className="absolute bottom-[-8%] left-[37%] h-[42%] w-[28%]"><Image src="/images/editorial/architecture.webp" alt="" fill sizes="30vw" className="object-cover"/></motion.div></div>
