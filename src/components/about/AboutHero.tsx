...
export default function AboutHero() {
  return <section className="grid min-h-[100svh] bg-[#080808] pt-[76px] md:grid-cols-2 md:pt-[88px]">
    <motion.div initial={{clipPath:'inset(100% 0 0 0)'}} animate={{clipPath:'inset(0% 0 0 0)'}} transition={{duration:1.25,ease:[.76,0,.24,1]}} className="relative min-h-[56vh] md:min-h-0"><Image src="/images/editorial/about-inspired.webp" alt="Photographe dans son studio, portrait d'ambiance" fill priority sizes="(max-width:768px) 100vw, 50vw" className="object-cover"/><div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"/><p className="absolute bottom-7 left-7 text-[7px] uppercase tracking-[.25em] text-white/55">Autoportrait · Paris</p></motion.div>
