  ...
  return <footer className="relative bg-[#070707] pb-8 pt-24">
    <div className="container-luxe">
      ...
      <div className="grid gap-12 py-16 md:grid-cols-[1.4fr_.6fr_.6fr]">
        ...
        <div><p className="mb-5 text-[8px] uppercase tracking-[.25em] text-[#c9a96e]">Explorer</p><ul className="space-y-3 text-xs text-white/60">{[['Portfolio','/portfolio'],['À propos','/a-propos'],['Services','/services'],['Contact','/contact']].map(([label,href]) => <li key={href}><Link href={href} className="link-line">{label}</Link></li>)}</ul></div>
